...
async def list_official_docs(
    ...
    official_docs=Depends(get_official_docs),
):
...
async def list_doc_categories(official_docs=Depends(get_official_docs)):
    return await official_docs.get_categories()


@router.post("/api/official-docs/refresh")
async def refresh_official_docs(official_docs=Depends(get_official_docs)):
